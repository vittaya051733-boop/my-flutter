        ...
        body: TabBarView(
          children: <Widget>[
            _MerchantReviewList(
              ...
              shopOwnerId: uid,
              titleField: 'productNameSnapshot',
              subtitleField: 'shopNameSnapshot',
            ),
            _MerchantReviewList(
              collection: 'shop_reviews',
              shopOwnerId: uid,
              titleField: 'shopNameSnapshot',
            ),
          ],
        ),
      ),
...
class _MerchantReviewList extends StatelessWidget {
  const _MerchantReviewList({
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return _ReadOnlyReviewCard(
              title: (review[titleField] as String?)?.trim().isNotEmpty == true
                  ? (review[titleField] as String).trim()
                  : 'รีวิว',
              subtitle: subtitleField == null
                  ? null
                  : (review[subtitleField] as String?)?.trim(),
              review: review,
            );
          },
        );
